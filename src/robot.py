...
class Robot():
    ...
    def calculate_R(self):
        ...
        :return:
        """
        return self.width / 2 * (self.speed[0] + self.speed[1]) / (self.speed[1] - self.speed[0])
    ...
    def calculate_rate_of_rotation(self):
        ...
        :return:
        """
        return (self.speed[1] - self.speed[0]) / self.width
    ...
    def get_ICC_coordinates(self, R):
        ...
        """
        R = self.calculate_R()
        return (self.x - R * math.sin(self.theta)), (self.y + self.theta * math.cos(self.theta))
    ...
    def update_position_test(self):
        """
        Calculate new position via forward kinematics
        :return:
        """
